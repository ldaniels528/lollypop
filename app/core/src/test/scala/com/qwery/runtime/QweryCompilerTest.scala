...
import com.qwery.runtime.instructions.expressions.aggregation.{Max, Min, Sum, Unique}
 ...
 */
class QweryCompilerTest extends AnyFunSpec {
  private val logger = LoggerFactory.getLogger(getClass)
  private implicit val compiler: QweryCompiler = QweryCompiler()

  describe(classOf[QweryCompiler].getSimpleName) {
