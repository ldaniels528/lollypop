...
class GTTest extends AnyFunSpec {

  describe(classOf[GT].getSimpleName) {

    it("should compare two Date instances") {
      val a: Option[Date] = DateHelper("2021-08-05T04:18:31.000Z")
    ...
    it("should compare two String instances") {
      val a: Option[String] = "zebra"
      val b: Option[String] = "monkey"
      assert(a > b)
    }

    it("should compare two UUID instances") {
      val a: Option[UUID] = UUID.fromString("7ca26d2e-e133-478c-9921-2126761d9340")
