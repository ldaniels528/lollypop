...
import com.qwery.runtime.datatypes.{DataType, PointerType}
import com.qwery.runtime.{LONG_BYTES, QweryNative}
 ...
 */
case class Pointer(offset: Long, allocated: Long, length: Long) extends Encodable with Instruction with QweryNative {
