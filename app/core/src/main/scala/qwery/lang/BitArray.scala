...
import com.qwery.runtime.datatypes.{BitArrayType, Int64Type, TableType}
...
import com.qwery.runtime.{Boolean2Int, INT_BYTES, LONG_BYTES, QweryNative, Scope}
import com.qwery.util.ByteBufferHelper.DataTypeBuffer
import com.qwery.util.OptionHelper.OptionEnrichment
import qwery.io.Decoder
import qwery.lang.BitArray.{BitArrayExtensions, ChangeListener, bitsPerRow, computeArraySize, encodedSize, setMask, toBinary, unsetMask}
 ...
 */
class BitArray(initialSize: Int, var floor: Long = 0) extends QweryNative with TableRendering {
