 ...
 */
class Matrix(val rows: Int, val cols: Int) extends TableRendering with Encodable with LollypopNative {
   ...
   * @throws LollypopException if both matrices have the same number of rows and columns.
   */
