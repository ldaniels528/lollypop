...
import com.lollypop.runtime.{DatabaseObjectNS, Scope}
...
/**
 * Lollypop Server Manager
 */
object LollypopServers {
  private val logger = LoggerFactory.getLogger(getClass)
  private val servers = TrieMap[Int, LollypopServer]()
  ...
  def startManually(port: Int)(implicit ctx: LollypopUniverse, timeout: Duration): LollypopServer = {
    val server = servers.getOrElseUpdate(port, LollypopServer(port, ctx))
