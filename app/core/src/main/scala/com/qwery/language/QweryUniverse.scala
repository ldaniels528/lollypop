...
object QweryUniverse {
  ...
  private val _languageParsers: List[LanguageParser] = List[LanguageParser](
    ...
    IF, Iff, Import, ImportImplicitClass, Include, Infix, IN, InsertInto, InterfacesOf, Intersect, Into, InvokeSQL,
    InvokeVirtualMethod, Is, IsCodecOf, IsDefined, IsJavaMember, IsNotNull, Isnt, IsNull,
    Join,
