 ...
 */
class QweryCompiler(val ctx: QweryUniverse) extends SQLCompiler {
...
/**
 * Qwery Compiler Companion
 * @author lawrence.daniels@gmail.com
 */
object QweryCompiler {

  /**
   * Creates an instance of the Qwery compiler
   * @param ctx the [[QweryUniverse compiler context]]
   * @return the [[QweryCompiler compiler]]
   */
  def apply(ctx: QweryUniverse = QweryUniverse()): QweryCompiler = new QweryCompiler(ctx)
