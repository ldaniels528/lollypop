...
import com.qwery.language.dieIllegalType
import com.qwery.language.models.{Condition, Expression, Instruction}
import com.qwery.runtime.QweryVM.implicits._
import com.qwery.runtime.devices.Field.ColumnToFieldExtension
import com.qwery.runtime.devices.IndexedRowCollection.{BIT_ARRAY_COLUMN_INDEX, BUCKETS, getHashIndexTableColumns}
...
import com.qwery.runtime.instructions.conditions.RuntimeCondition.RichConditionAtRuntime
import com.qwery.runtime.instructions.conditions.{EQ, Is, Isnt, NEQ}
import com.qwery.runtime.instructions.expressions.RuntimeExpression.RichExpression
import com.qwery.runtime.{DatabaseObjectNS, QweryVM, ROWID, ResourceManager, Scope}
...
class HashIndexRowCollection(override val ns: DatabaseObjectNS,
  ...
  override def iterateWhere(condition: Option[Condition] = None, limit: Option[Expression] = None)
    ...
    if (args.nonEmpty) {
      val (s, c, r) = QweryVM.transform(scope, args)
      (for {
