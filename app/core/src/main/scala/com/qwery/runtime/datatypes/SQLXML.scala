...
import com.qwery.runtime.DatabaseObjectNS
import com.qwery.runtime.datatypes.SQLXML.SYSTEM_ID
...
/**
 * Qwery-native JDBC-compatible SQL/XML implementation
 ...
 */
object SQLXML {
  private val SYSTEM_ID = s"Qwery_v${AppConstants.version}"
