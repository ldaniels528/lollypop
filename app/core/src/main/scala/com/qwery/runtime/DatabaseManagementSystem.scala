...
import com.qwery.language.{TokenStream, dieFunctionNotCompilable, dieNoSuchColumn, dieObjectAlreadyExists, dieObjectIsNotAUserFunction}
import com.qwery.runtime.DatabaseObjectConfig._
import com.qwery.runtime.ResourceManager.RowCollectionTracker
import com.qwery.runtime.RuntimeFiles.RecursiveFileList
import com.qwery.runtime.datatypes._
import com.qwery.runtime.devices.ProductCollection.toColumns
import com.qwery.runtime.devices.RowCollection.dieNotSubTable
import com.qwery.runtime.devices.TableColumn.implicits.{SQLToColumnConversion, TableColumnToSQLColumnConversion}
...
import com.qwery.runtime.instructions.queryables.RuntimeQueryable.getQueryReferences
...
trait DatabaseManagementSystem {
   ...
   * @example {{{
   *  objectOf("com.qwery.runtime.DatabaseManagementSystem").deleteTempFiles(Interval('5 minutes'))
   * }}}
   */
  ...
  def createVirtualTable(ns: DatabaseObjectNS, view: View, ifNotExists: Boolean)(implicit scope: Scope): IOCost = {
    ...
    val cost0 = if (ns.configFile.exists() && !ifNotExists) dieObjectAlreadyExists(ns)
      ...
      val (_, cost0, result1) = QweryVM.searchSQL(scope, view.query.toSQL)
