node.api('/api/shocktrade/orders', {
    //////////////////////////////////////////////////////////////////////////////////////
    // creates a new order
    // www post 'http://{{host}}:{{port}}/api/shocktrade/orders'
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    // retrieves an order
    // www get 'http://{{host}}:{{port}}/api/shocktrade/orders?id=2187296c-7bf6-4c1d-a87d-fdc3dae39dc8'
    //////////////////////////////////////////////////////////////////////////////////////
    get: (id: UUID) => {
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    // updates an order
    // www put 'http://{{host}}:{{port}}/api/shocktrade/orders' <~ { id: "0a3dd064-b3c7-4c44-aad0-c7bd94e1f929", name: "Winter is coming" }
    //////////////////////////////////////////////////////////////////////////////////////
    ...
    //////////////////////////////////////////////////////////////////////////////////////
    // deletes an order
    // www delete 'http://{{host}}:{{port}}/api/shocktrade/orders' <~ { id: "0a3dd064-b3c7-4c44-aad0-c7bd94e1f929" }
    //////////////////////////////////////////////////////////////////////////////////////
    delete: (id: UUID) => {
...
node.api('/api/shocktrade/orders/by/contest', {
    //////////////////////////////////////////////////////////////////////////////////////
    // searches for orders by contest ID
    // www get 'http://{{host}}:{{port}}/api/shocktrade/orders/by/contest?id=aa440939-89cb-4ba1-80b6-20100ba6a286'
    //////////////////////////////////////////////////////////////////////////////////////
    get: (id: UUID) => {
...
node.api('/api/shocktrade/orders/by/participant', {
    //////////////////////////////////////////////////////////////////////////////////////
    // searches for orders by participant ID
    // www get 'http://{{host}}:{{port}}/api/shocktrade/orders/by/participant?id=fad8f33b-18c1-416d-ae8f-3b309d3f9589'
    //////////////////////////////////////////////////////////////////////////////////////
    get: (id: UUID) => {
